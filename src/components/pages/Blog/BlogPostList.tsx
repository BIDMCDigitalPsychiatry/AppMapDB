...
import { Box, Button, Container, createStyles, Divider, Grid, IconButton, InputAdornment, makeStyles, TextField, Typography } from '@material-ui/core';
...
const BlogPostList = () => {
  ...
  const filtered = sortPosts(
    searchPosts(
      posts.filter(p => (showArchived ? p.deleted : !p.deleted)),
      search
    ),
    sortOption
  );
